...
const paths = {
	...
	styles: {
		src: ['dev/less/styles.css', '!dev/optional/**/*.*'],
		dest: 'css',
		less: ['dev/less/*.less']
	},
	scripts: {
...
/**
 * Less, if that's being used.
 */
export function lessStyles() {
	return gulp.src(paths.styles.less,  { base: "./" })
...
export function watch() {
	...
	gulp.watch(paths.styles.less, lessStyles);
 ...
 */
const firstRun = gulp.series(php, gulp.parallel(scripts, jsMin, jsLibs), lessStyles, styles, images, serve, watch);
